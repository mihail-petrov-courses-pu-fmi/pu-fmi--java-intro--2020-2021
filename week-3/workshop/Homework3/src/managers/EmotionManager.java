...
public class EmotionManager {
    ...
    private static int produceEmotion() {
        ...
        boolean shouldActivateNegativeEmotion   = (temporalEmotionCoefficient >= 60 && temporalEmotionCoefficient <= 80) &&
                (temporalEmotionCoefficient % 3 == 0);

        boolean shouldActivatePositiveEmotion   = (temporalEmotionCoefficient >= 5 && temporalEmotionCoefficient <= 55) &&
