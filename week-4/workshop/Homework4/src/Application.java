...
public class Application {
    ...
    // изнасям го като статична променливна
    ...
    public static void move(String direction) {
        ...
        // копираме оригиналната колекция съсдържаща позициите на специалистите.
        int[][] originalUnitCollection = Collection.copy(unitCollection);

        // ред и колона към която съм се отправил,
        ...
        if(isMovePossible(destinationRow, destinationCol)) {
            ...
            // с цел гарантиране на сигурността на потенциално придвижване от другия край на картата
            destinationRow = transformRow(destinationRow);
            destinationCol = transformCol(destinationCol);

            // определяме координати на първия елемент
            unitCollection[0][0] = destinationRow;
            unitCollection[0][1] = destinationCol;

            // определим координатите на всички останали елементи
