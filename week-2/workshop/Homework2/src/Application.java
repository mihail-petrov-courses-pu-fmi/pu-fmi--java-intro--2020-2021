...
public class Application {
    ...
    // 3. Проверка на VIP статуса на гласоподавателя
    public static boolean isVoterVip(int cardNumber) {

        // 123456 / 10 => 12345.6 => 12345
        // 123456 % 10 => 12345.6 => 6
    ...
    public static void main(String[] args) {
        ...
        // 2. Извеждане на съобщение базирано на статуса на гласуващия
        ...
        // 4. Проверка за укриване на данъци
        ...
        if(isVoterPotentialTaxFraud(cardNumber)) {
            ...
            String message =  (questionAnswer.equals("Y"))
                                ? "Браво моето момче"
                                : "Будала";
            isVoterATaxFraud = (questionAnswer.equals("Y")); // Y => true
            System.out.println(message);
        }

        // 5. Проверка за баничка
        ...
        // 6. Санкция за нормалните, честни, гладни хора
